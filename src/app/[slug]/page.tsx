  ...
  return (
    <div className="px-4 md:px-8 lg:px-16 xl:32 2xl:px-64 relative flex flex-col lg:flex-row gap-16">
      ...
      <div className="w-full lg:w-1/2 flex flex-col gap-6">
        <div className="text-4xl font-medium">{products.items[0].name}</div>
        <p className="text-gray-500">{products.items[0].description}</p>
        <div className="h-[2px] bg-gray-100 " />
        <div className="flex items-center gap-4">
          <h3 className="text-xl text-grey-500 line-through">
            {products.items[0].convertedPriceData?.formatted?.price}
          </h3>
          <h2 className="font-medium text-2xl">
            {products.items[0].convertedPriceData?.formatted?.discountedPrice}
          </h2>
        </div>
